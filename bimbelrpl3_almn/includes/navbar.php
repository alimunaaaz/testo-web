            ...
            <ul class="navbar-nav ms-auto">
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <div class="d-flex align-items-center">
                        <button onclick="toggleTheme()" class="btn btn-link text-white me-2 p-0 border-0 shadow-none">
                        ...
                        <li class="nav-item dropdown" style="list-style: none;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                                <li><a class="dropdown-item" href="<?php echo $base_url; ?><?php echo $_SESSION['role']; ?>/profile.php">
                                    <i class="fas fa-user-edit me-2 text-muted"></i> Profile</a>
                                </li>
                                <li><a class="dropdown-item" href="<?php echo $base_url; ?><?php echo $_SESSION['role']; ?>/security.php">
                                    <i class="fas fa-shield-alt me-2 text-muted"></i> Security</a>
                                </li>
