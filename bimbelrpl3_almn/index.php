...
<body>
    ...
    <div class="container">
        ...
        <div class="ms-auto d-flex align-items-center">
            <button onclick="toggleTheme()" class="btn btn-link text-white me-3 p-0 border-0" id="theme-toggle" title="Ganti Tema">
    ...
    <section class="py-5 bg-white"> <div class="container">
        <h2 class="text-center fw-bold mb-4">Cara Kerjanya?</h2>
        <p class="text-center text-muted">Hanya 4 langkah mudah!</p>
        </div>
</section>
